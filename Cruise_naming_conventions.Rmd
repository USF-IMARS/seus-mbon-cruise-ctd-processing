...
directory_path <- "data/01_raw/raw_ctd_data"
...
directory_path <- "data/01_raw/Cruises_with Right_convention_names"
...
file_path <- "data/01_raw/raw_ctd_data/WS1018_ctd_comb.csv"
...
# Define the path to the specific CSV file
file_path <- "data/cleaned/WS1018.CSV"
...
output_dir <- "data/01_raw/Cruises_with Right_convention_names"
...
input_dir <- "data/01_raw/combined_fl_keys_data"
output_dir <- "data/01_raw/Cruises_with Right_convention_names"
...
original_dir <- "data/01_raw/combined_fl_keys_data"
cleaned_dir <- "data/01_raw/Cruises_with Right_convention_names"
...
file_before_cleaning <- "data/01_raw/raw_ctd_data/WS0901_ctd_comb.csv"
file_after_cleaning <- "data/cleaned/WS0901.csv"
